...
insert into member2 values (default,'admin','1234','관리맨','관리자','남자',default,'010-1234-1234','서울 / / /','cjsk1126@naver.com','','학생','등산','noimage.jpg','',default,default,default,default,default,default,default,default);
