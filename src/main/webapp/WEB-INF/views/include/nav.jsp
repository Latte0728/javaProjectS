...
<script>
	...
	function memberDelete() {
		...
		if(res) {
			location.href='${ctp}/member/memberDelete?sMid=${sMid}';
		}
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.56:9090/javaProjectS" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    ...
    <c:if test="${!empty sLevel}">
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        ...
	        <a href="${ctp}/member/pwdChange" class="w3-bar-item w3-button">비밀번호변경</a>
